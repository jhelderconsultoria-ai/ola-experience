...
const FOTO_PATH = path.resolve('TEMPESTADE DE IDEIAS/assets-pdf/dia1-alimentacao.jpg');
const OUT = path.resolve('TEMPESTADE DE IDEIAS/capa-produto-mapa-do-hoje--v1--20260910.png');
