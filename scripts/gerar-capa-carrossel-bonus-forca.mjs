// Capa fotografica do carrossel bonus "Juntos, a vida fica mais leve" (pilar Forca).
import path from 'path';
import sharp from 'sharp';

const SRC = path.resolve('INSTAGRAM OLÁ/POSTAGENS EXTRAS/bonus-forca-compras-postado-10-09-2026/arte-bruta/bonus-forca-compras-raw--v3--20260910-1555.png');
const LOGO_PATH = path.resolve('INSTAGRAM OLÁ/conteudo-inicial/marca-ola-experience-caminho-transparente.png');
const OUT = path.resolve('INSTAGRAM OLÁ/POSTAGENS EXTRAS/bonus-forca-compras-postado-10-09-2026/carrossel/01-capa.png');
...
const HEADLINE = 'Juntos, a vida fica mais leve';
