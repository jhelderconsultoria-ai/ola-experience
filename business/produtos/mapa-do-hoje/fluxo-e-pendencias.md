...
**Última atualização:** 10/09/2026, ~21h
...
flowchart TD
    ...
    E --> F{Verificacao KYC<br/>Hotmart}
    F -->|aguardando, ate 5 dias uteis| G[Produto aprovado]
    ...
    class A,B,C,D,E,H done;
    class F,G,I,J,K,L,M pending;
    class N,O blocked;
```
...
- [ ] **Aprovação do KYC (verificação de identidade)** pela Hotmart — documentos já enviados, resposta por e-mail em até 5 dias úteis
- [ ] **Automação do eNotas com a Hotmart** — pagamento em análise antifraude pela operadora; depois disso vem o e-mail de onboarding/configuração fiscal (OCR de documentos)
- [ ] Link de checkout (só é liberado depois da aprovação do produto pela Hotmart)
- [ ] Atualizar o botão da página de vendas (`docs/mapa-do-hoje/index.html`) com o link real de checkout
