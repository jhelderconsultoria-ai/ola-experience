// Capa fotografica do carrossel bonus "O medo que ela guardou" (pilar Emocional).
import path from 'path';
import sharp from 'sharp';

const SRC = path.resolve('INSTAGRAM OLÁ/POSTAGENS EXTRAS/bonus-emocional-medo-nori-postado-10-09-2026/arte-bruta/bonus-emocional-medo-nori-raw--v2--20260910-1525.png');
const LOGO_PATH = path.resolve('INSTAGRAM OLÁ/conteudo-inicial/marca-ola-experience-caminho-transparente.png');
const OUT = path.resolve('INSTAGRAM OLÁ/POSTAGENS EXTRAS/bonus-emocional-medo-nori-postado-10-09-2026/carrossel/01-capa.png');
...
const HEADLINE = 'O medo que ela guardou';
