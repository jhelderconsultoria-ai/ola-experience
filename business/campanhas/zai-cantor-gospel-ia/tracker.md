...
|--------|------|--------|------------|-------|
| Escolher ferramenta de geração musical com voz (ex.: Suno) | Jorge | Não iniciado | — | Precisa gerar áudio real (voz + instrumental), não só letra em texto |
| Escolher agregador de distribuição digital (ex.: DistroKid, Amuse, TuneCore) | Jorge | Não iniciado | — | É quem publica a faixa em Spotify/Apple Music/YouTube com o nome do artista |
| Definir nome artístico e identidade visual do Zai como cantor | Jorge + Claude | Não iniciado | — | Referência: Hikari de Jesus tem biografia fixa e um detalhe visual marcante (tatuagens ligadas ao "antes" dele) — pensar em algo equivalente pro Zai |
| Criar conta Instagram separada para o artista | Jorge | Não iniciado | Nome artístico definido | Bio, destaques (Spotify/YouTube/Apple Music/Sobre mim), padrão visto no @hikaridejesus |
