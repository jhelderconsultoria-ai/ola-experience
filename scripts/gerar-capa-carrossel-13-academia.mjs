// Capa fotografica do carrossel do episodio T1E12 (duas horas so nossas),
// mesmo padrao visual dos episodios anteriores.
import path from 'path';
import sharp from 'sharp';

const SRC = path.resolve('INSTAGRAM OLÁ/Temporada Jornada Olá/Temporada 1/T1E12-duas-horas-nossas-postado-06-09-2026/arte-bruta/13-academia-raw.png');
const LOGO_PATH = path.resolve('INSTAGRAM OLÁ/conteudo-inicial/marca-ola-experience-caminho-transparente.png');
const OUT = path.resolve('INSTAGRAM OLÁ/Temporada Jornada Olá/Temporada 1/T1E12-duas-horas-nossas-postado-06-09-2026/carrossel/01-capa.png');
...
async function main() {
  ...
  <svg width="${W}" height="${H}" xmlns="http://www.w3.org/2000/svg">
    ...
    <text x="70" y="76" class="eyebrow">FAMÍLIA HORIZONTE · T1E12</text>
