...
const SRC = path.resolve('INSTAGRAM OLÁ/conteudo-inicial/01-familia-ola-apresentacao-marca-v3.png');
const OUT = path.resolve('INSTAGRAM OLÁ/conteudo-inicial/01-familia-ola-apresentacao-episodio.png');
