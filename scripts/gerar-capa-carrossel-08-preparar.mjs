// Capa fotografica do carrossel do episodio 7 (preparar tambem faz parte,
// rotulo T1E07), mesmo padrao visual dos episodios anteriores.
...
const OUT = path.resolve('INSTAGRAM OLÁ/Temporada Jornada Olá/Temporada 1/T1E07-preparar-postado-06-09-2026/carrossel/01-capa.png');
...
async function main() {
  ...
  <svg width="${W}" height="${H}" xmlns="http://www.w3.org/2000/svg">
    ...
    <text x="70" y="76" class="eyebrow">FAMÍLIA HORIZONTE · T1E07</text>
    <text x="${W - 70}" y="76" text-anchor="end" class="badge">1/4</text>
    <text x="50%" y="${H - 290}" text-anchor="middle" class="headline">
      <tspan x="50%" dy="0">Preparar também</tspan>
      <tspan x="50%" dy="58">faz parte</tspan>
    </text>
