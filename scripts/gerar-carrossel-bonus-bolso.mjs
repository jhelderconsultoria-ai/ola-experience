// Carrossel bonus "Economizar pra sonhar junto" (pilar Bolso, OLA BONUS).
import fs from 'fs';
import path from 'path';
import sharp from 'sharp';

const OUT_DIR = path.resolve('INSTAGRAM OLÁ/POSTAGENS EXTRAS/bonus-bolso-planilha-postado-10-09-2026/carrossel');
...
const slides = [
  {
    ...
    lines: ['Economizar pra', 'sonhar junto'],
    badge: '1/4',
    showArrow: true,
  },
  {
    ...
    eyebrow: 'ZAI, 15 ANOS',
    quoteMark: true,
    lines: ['Cortar um lanche fora', 'pra pagar uma viagem inteira?'],
    footer: 'Vale muito mais a pena.',
    badge: '2/4',
    showArrow: true,
  },
  {
    name: '03-mensagem',
    eyebrow: 'BOLSO NA PRÁTICA',
    lines: ['Dinheiro também é', 'decisão em família'],
    footer: 'não só quanto sobra, mas pra onde vai.',
    badge: '3/4',
    showArrow: true,
  },
  {
    ...
    lines: ['Qual seria o corte', 'de vocês essa semana?'],
