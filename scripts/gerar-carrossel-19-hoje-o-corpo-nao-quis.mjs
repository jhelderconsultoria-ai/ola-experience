// Carrossel "Hoje o corpo nao quis" (episodio T1E18, Familia Horizonte, Bloco Cardio).
import fs from 'fs';
import path from 'path';
import sharp from 'sharp';

const OUT_DIR = path.resolve('INSTAGRAM OLÁ/Temporada Jornada Olá/Temporada 1/T1E18-hoje-o-corpo-nao-quis/carrossel');
...
const slides = [
  {
    name: '01-capa',
    eyebrow: 'FAMÍLIA HORIZONTE · T1E18',
    lines: ['Hoje o corpo', 'não quis'],
    badge: '1/4',
    showArrow: true,
  },
  {
    ...
    eyebrow: 'LU, 38 ANOS',
    quoteMark: true,
    lines: ['Hoje eu escolhi', 'o chá em vez do tênis.'],
    footer: 'Sem culpa nenhuma nisso.',
    badge: '2/4',
    showArrow: true,
  },
  {
    ...
    lines: ['Cardio também é', 'saber ouvir o dia'],
    footer: 'que pede pausa — sem pressa nenhuma.',
    badge: '3/4',
    showArrow: true,
  },
  {
    ...
    lines: ['Vocês também têm', 'dias de "hoje não"?'],
