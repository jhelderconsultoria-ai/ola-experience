// Adiciona o retrato circular do Zai no slide de fala (02-zai) do
// carrossel 08 (preparar tambem faz parte), recortado da arte de origem.
import path from 'path';
import sharp from 'sharp';

const SRC = path.resolve('INSTAGRAM OLÁ/Temporada Jornada Olá/Temporada 1/T1E07-preparar-postado-06-09-2026/arte-bruta/08-preparar-raw.png');
const OUT_DIR = path.resolve('INSTAGRAM OLÁ/Temporada Jornada Olá/Temporada 1/T1E07-preparar-postado-06-09-2026/carrossel');
...
// Caixa de rosto conferida a olho na arte 1536x1024 (08-preparar-raw.png).
const FACE_BOX = { left: 555, top: 215, size: 210 };
...
const slide = {
  ...
  eyebrow: 'ZAI, 15 ANOS',
  quoteMark: true,
  lines: ['Se eu escolho o que', 'eu levo, eu já', 'tô participando.'],
  footer: 'Preparar junto também é aventura.',
  badge: '2/4',
  showArrow: true,
};
