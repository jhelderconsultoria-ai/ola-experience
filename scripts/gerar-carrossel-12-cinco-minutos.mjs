// Carrossel "Cinco minutos só meus" (episodio T1E11, Familia Horizonte).
import fs from 'fs';
import path from 'path';
import sharp from 'sharp';

const OUT_DIR = path.resolve('INSTAGRAM OLÁ/Temporada Jornada Olá/Temporada 1/T1E11-cinco-minutos-postado-06-09-2026/carrossel');
...
const slides = [
  {
    name: '01-capa',
    eyebrow: 'FAMÍLIA HORIZONTE · T1E11',
  ...
  },
  {
    name: '03-mensagem',
    eyebrow: 'NA COZINHA',
    lines: ['Autocuidado não é', 'uma grande mudança.'],
    badge: '3/4',
    showArrow: true,
  },
  {
    ...
    lines: ['Pequenos espaços', 'protegidos também contam.'],
