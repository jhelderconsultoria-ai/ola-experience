// Carrossel bonus "O que a Lu aguentou sem ninguem ver" (pilar Forca, OLA BONUS).
import fs from 'fs';
import path from 'path';
import sharp from 'sharp';

const OUT_DIR = path.resolve('INSTAGRAM OLÁ/POSTAGENS EXTRAS/bonus-forca-compras-postado-10-09-2026/carrossel');
...
const slides = [
  {
    ...
    lines: ['Juntos, a vida', 'fica mais leve'],
    badge: '1/4',
    showArrow: true,
  },
  {
    ...
    quoteMark: true,
    lines: ['Cada um levou uma', 'sacola. Ninguém sozinho.'],
    footer: 'Até o Thor achou que ajudou.',
    badge: '2/4',
    showArrow: true,
  },
  {
    name: '03-mensagem',
    eyebrow: 'FORÇA NA PRÁTICA',
    lines: ['Força também é', 'dividir o peso junto'],
    footer: 'não é sobre aguentar sozinho.',
    badge: '3/4',
    showArrow: true,
  },
  {
    ...
    lines: ['Na sua casa, quem', 'ajuda a carregar?'],
