// Capa fotografica do carrossel do episodio T1E16 (finalmente saiu).
...
const OUT = path.resolve('INSTAGRAM OLÁ/Temporada Jornada Olá/Temporada 1/T1E16-finalmente-saiu-postado-07-09-2026/carrossel/01-capa.png');
...
const HEADLINE = 'Finalmente Saiu';
...
async function main() {
  ...
  <svg width="${W}" height="${H}" xmlns="http://www.w3.org/2000/svg">
    ...
    <text x="70" y="76" class="eyebrow">FAMÍLIA HORIZONTE · T1E16</text>
