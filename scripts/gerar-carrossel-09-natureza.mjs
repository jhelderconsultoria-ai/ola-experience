// Carrossel "A primeira experiência na natureza" (episodio T1E08, Familia
// Horizonte) — slides de texto, mesma paleta oficial da Ola.
import fs from 'fs';
import path from 'path';
import sharp from 'sharp';

const OUT_DIR = path.resolve('INSTAGRAM OLÁ/Temporada Jornada Olá/Temporada 1/T1E08-natureza-postado-06-09-2026/carrossel');
...
const slides = [
  {
    name: '01-capa',
    eyebrow: 'FAMÍLIA HORIZONTE · T1E08',
    lines: ['A primeira experiência', 'na natureza'],
    badge: '1/4',
    showArrow: true,
  },
  {
    ...
    eyebrow: 'NORI, 8 ANOS',
    quoteMark: true,
    lines: ['Achei uma coisa', 'aqui, vem ver!'],
    footer: 'Puxou todo mundo pro riacho.',
    badge: '2/4',
    showArrow: true,
  },
  {
    name: '03-mensagem',
    eyebrow: 'NO RIACHO',
    lines: ['Não precisa de trilha longa.', 'Só precisa de vontade de descobrir.'],
    badge: '3/4',
    showArrow: true,
  },
  {
    ...
    lines: ['A aventura mora', 'no que já dá pra fazer.'],
