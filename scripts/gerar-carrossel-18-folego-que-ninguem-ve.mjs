// Carrossel "O folego que ninguem ve" (episodio T1E17, Familia Horizonte, Bloco Cardio).
import fs from 'fs';
import path from 'path';
import sharp from 'sharp';

const OUT_DIR = path.resolve('INSTAGRAM OLÁ/Temporada Jornada Olá/Temporada 1/T1E17-folego-que-ninguem-ve/carrossel');
...
const slides = [
  {
    name: '01-capa',
    eyebrow: 'FAMÍLIA HORIZONTE · T1E17',
    lines: ['O fôlego que', 'ninguém vê'],
    badge: '1/4',
    showArrow: true,
  },
  {
    ...
    quoteMark: true,
    lines: ['Antes eu chegava', 'e desabava no sofá.'],
    footer: 'Hoje ainda sobra gás pra brincar.',
    badge: '2/4',
    showArrow: true,
  },
  {
    name: '03-mensagem',
    eyebrow: 'CARDIO NA PRÁTICA',
    lines: ['O treino não é sobre', 'a hora que você faz.'],
    footer: 'É sobre a energia que sobra depois dela.',
    badge: '3/4',
    showArrow: true,
  },
  {
    ...
    lines: ['Qual atividade te', 'devolve energia?'],
