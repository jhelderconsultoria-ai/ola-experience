// Carrossel "Um presente de quatro patas" (episodio 5, Familia Horizonte,
// rotulo T1E05) — formato texto puro, mesma paleta oficial da Ola.
import fs from 'fs';
import path from 'path';
import sharp from 'sharp';

const OUT_DIR = path.resolve('INSTAGRAM OLÁ/Temporada Jornada Olá/Temporada 1/T1E05-thor-postado-05-09-2026/carrossel');
...
const slides = [
  {
    name: '01-capa',
    eyebrow: 'FAMÍLIA HORIZONTE · T1E05',
    lines: ['Essa surpresa', 'tinha quatro patas'],
    badge: '1/4',
    showArrow: true,
  },
  {
  ...
  },
  {
    name: '03-mensagem',
    eyebrow: 'BEM-VINDO',
    lines: ['Alguns presentes', 'não vêm embrulhados.', 'Vêm pra ficar.'],
    badge: '3/4',
    showArrow: true,
  },
  {
    ...
    lines: ['A família ganhou', 'mais um coração.'],
    footer: 'Bem-vindo, Thor.',
    badge: '4/4',
    showArrow: false,
  },
];
