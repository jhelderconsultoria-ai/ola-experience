// Capa fotografica do carrossel do episodio 5 (chegada do Thor, rotulo T1E05),
// mesmo padrao visual dos episodios anteriores.
import path from 'path';
import sharp from 'sharp';

const SRC = path.resolve('INSTAGRAM OLÁ/Temporada Jornada Olá/Temporada 1/T1E05-thor-postado-05-09-2026/arte-bruta/06-thor-chegada-raw.png');
const LOGO_PATH = path.resolve('INSTAGRAM OLÁ/conteudo-inicial/marca-ola-experience-caminho-transparente.png');
const OUT = path.resolve('INSTAGRAM OLÁ/Temporada Jornada Olá/Temporada 1/T1E05-thor-postado-05-09-2026/carrossel/01-capa.png');
...
async function main() {
  // 'contain' preserva a cena toda (Nori, Thor, Nilo, Lu e o Zai ao fundo),
  // evita repetir o erro do episodio 4 (fit:'cover' cortando personagens nas pontas).
  ...
  <svg width="${W}" height="${H}" xmlns="http://www.w3.org/2000/svg">
    ...
    <text x="70" y="76" class="eyebrow">FAMÍLIA HORIZONTE · T1E05</text>
    <text x="${W - 70}" y="76" text-anchor="end" class="badge">1/4</text>
    <text x="50%" y="${H - 290}" text-anchor="middle" class="headline">
      <tspan x="50%" dy="0">Essa surpresa</tspan>
      <tspan x="50%" dy="58">tinha quatro patas</tspan>
    </text>
