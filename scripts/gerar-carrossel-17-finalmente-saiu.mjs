// Carrossel "Finalmente Saiu" (episodio T1E16, Familia Horizonte, Bloco Cardio).
import fs from 'fs';
import path from 'path';
import sharp from 'sharp';

const OUT_DIR = path.resolve('INSTAGRAM OLÁ/Temporada Jornada Olá/Temporada 1/T1E16-finalmente-saiu-postado-07-09-2026/carrossel');
...
const slides = [
  {
    name: '01-capa',
    eyebrow: 'FAMÍLIA HORIZONTE · T1E16',
    lines: ['Finalmente', 'Saiu'],
    badge: '1/6',
    showArrow: true,
  },
  {
    ...
    eyebrow: 'ZAI, 15 ANOS',
    quoteMark: true,
    lines: ['Isso ainda vai', 'dar certo.'],
    footer: 'Pra quem segura e não solta a mão.',
    badge: '2/6',
    showArrow: true,
  },
  {
    name: '03-mensagem',
    eyebrow: 'UMA CANÇÃO GUARDADA',
    lines: ['Cada corda que ele', 'tocou foi uma oração.'],
    badge: '3/6',
    showArrow: true,
  },
  {
    ...
    quoteMark: true,
    lines: ['Eu só peguei o violão.', 'A ideia... essa eu sei', 'que não veio só de mim.'],
    footer: 'Obrigado, do jeito que eu sei agradecer.',
    badge: '4/6',
    showArrow: true,
  },
  {
    ...
    lines: ['A fé não promete', 'um caminho fácil.'],
