// Capa fotografica do carrossel bonus "Economizar pra sonhar junto" (pilar Bolso).
import path from 'path';
import sharp from 'sharp';

const SRC = path.resolve('INSTAGRAM OLÁ/POSTAGENS EXTRAS/bonus-bolso-planilha-postado-10-09-2026/arte-bruta/bonus-bolso-planilha-raw--v2--20260910-1525.png');
const LOGO_PATH = path.resolve('INSTAGRAM OLÁ/conteudo-inicial/marca-ola-experience-caminho-transparente.png');
const OUT = path.resolve('INSTAGRAM OLÁ/POSTAGENS EXTRAS/bonus-bolso-planilha-postado-10-09-2026/carrossel/01-capa.png');
...
const HEADLINE = 'Economizar pra sonhar junto';
