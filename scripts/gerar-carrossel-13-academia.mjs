// Carrossel "Duas horas só nossas" (episodio T1E12, Familia Horizonte,
// fechamento com 3 pilares) — slides de texto, mesma paleta oficial da Ola.
import fs from 'fs';
import path from 'path';
import sharp from 'sharp';

const OUT_DIR = path.resolve('INSTAGRAM OLÁ/Temporada Jornada Olá/Temporada 1/T1E12-duas-horas-nossas-postado-06-09-2026/carrossel');
...
const slides = [
  {
    name: '01-capa',
    eyebrow: 'FAMÍLIA HORIZONTE · T1E12',
