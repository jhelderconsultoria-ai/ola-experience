// Carrossel bonus "A bagunca da panqueca" (pilar Alimentacao, OLA BONUS).
import fs from 'fs';
import path from 'path';
import sharp from 'sharp';

const OUT_DIR = path.resolve('INSTAGRAM OLÁ/POSTAGENS EXTRAS/bonus-alimentacao-panqueca-postado-10-09-2026/carrossel');
...
const slides = [
  ...
  },
  {
    ...
    eyebrow: 'NORI, 8 ANOS',
    quoteMark: true,
    lines: ['Derramei leite', 'em tudo. De novo.'],
    footer: 'Ninguém ligou.',
    badge: '2/4',
    showArrow: true,
  },
  {
    name: '03-mensagem',
    eyebrow: 'ALIMENTAÇÃO NA PRÁTICA',
    lines: ['Comer junto começa', 'muito antes do prato'],
    footer: 'no preparo bagunçado, sem pressa nenhuma.',
    badge: '3/4',
    showArrow: true,
  },
  {
    ...
    lines: ['Vocês também têm', 'essa bagunça de sábado?'],
