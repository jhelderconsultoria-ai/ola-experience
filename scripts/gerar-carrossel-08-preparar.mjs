// Carrossel "Preparar também faz parte" (episodio 7, Familia Horizonte,
// rotulo T1E07) — formato texto puro, mesma paleta oficial da Ola.
import fs from 'fs';
...
function footerFontSize(texto, showArrow) {
  const BASE = 38, MAX_W = showArrow ? 700 : 940, CHAR_W = 0.58, MIN = 22;
...
const slides = [
  {
    name: '01-capa',
    eyebrow: 'FAMÍLIA HORIZONTE · T1E07',
    lines: ['Preparar também', 'faz parte'],
    badge: '1/4',
    showArrow: true,
  },
  {
  ...
  {
    name: '03-mensagem',
    eyebrow: 'NA SALA DE CASA',
    lines: ['Ninguém foi mandado.', 'Ninguém ficou de fora.'],
    badge: '3/4',
    showArrow: true,
  },
  {
    ...
    lines: ['A aventura começa', 'antes de sair de casa.'],
