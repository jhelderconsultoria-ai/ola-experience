...
- [x] **Artes dos 3 pinned posts produzidas** (12/09/2026, Squad Carrossel Arcane) — 18 slides (Sobre 5, Tese 5, Oferta 8), organizados em `pinned-posts/pinned-0{1,2,3}-.../` (abaixo), cada slide renomeado com número + slug da frase. Detalhes em `REELS TURBINAR/A Maldição do Depois/pinned-posts-squad-posicionamento.md`.
...
- [x] **Logo subida no Perfil Público da Hotmart** (12/09/2026) — 4ª tentativa via automação também não persistiu (mesmo bloqueio das anteriores), Jorge Helder fez manualmente pelo navegador com `docs/assets/logo-quadrada-perfil.png`. Confirmado ao vivo na página pública do produto — logo aparece em "Saiba mais sobre quem criou o conteúdo".
