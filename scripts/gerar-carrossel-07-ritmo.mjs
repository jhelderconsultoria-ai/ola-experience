// Carrossel "Cada pessoa tem seu ritmo" (episodio 6, Familia Horizonte,
// rotulo T1E06) — formato texto puro, mesma paleta oficial da Ola.
import fs from 'fs';
...
const slides = [
  {
    name: '01-capa',
    eyebrow: 'FAMÍLIA HORIZONTE · T1E06',
    lines: ['Cada um no seu', 'próprio ritmo'],
    badge: '1/4',
    showArrow: true,
  },
  {
  ...
  },
  {
    name: '03-mensagem',
    eyebrow: 'NA TRILHA',
    lines: ['Ninguém espera.', 'Ninguém cobra.', 'Cada um no seu tempo.'],
    badge: '3/4',
    showArrow: true,
  },
  {
    ...
    lines: ['Juntos não é', 'sobre o mesmo passo.'],
    footer: 'É sobre estar na mesma jornada.',
    badge: '4/4',
    showArrow: false,
  },
];
