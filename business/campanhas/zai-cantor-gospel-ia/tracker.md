...
|--------|------|--------|------------|-------|
| Escolher ferramenta de geração musical com voz (ex.: Suno) | Jorge | Não iniciado | — | Suno x Udio já comparados (seção 7 do plano) — falta fechar a escolha |
| Escolher agregador de distribuição digital (ex.: DistroKid, Amuse, TuneCore) | Jorge | Não iniciado | — | Amuse sugerido (seção 7 do plano) — falta confirmação final |
