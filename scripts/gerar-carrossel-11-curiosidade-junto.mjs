// Carrossel "A mesma tela, de um jeito diferente" (episodio T1E10, Familia Horizonte).
import fs from 'fs';
...
const slides = [
  {
    name: '01-capa',
    eyebrow: 'FAMÍLIA HORIZONTE · T1E10',
    lines: ['A mesma tela,', 'de um jeito diferente'],
    badge: '1/4',
    showArrow: true,
  },
  {
  ...
  {
    name: '03-mensagem',
    eyebrow: 'NA MESA DA SALA',
    lines: ['Todo mundo olhando', 'pra mesma coisa, juntos.'],
    badge: '3/4',
    showArrow: true,
  },
  {
    ...
    lines: ['Tecnologia não é vilã', 'quando une, não isola.'],
