...
**Racional do expert:** mesmo com poucos seguidores hoje, e uma forma de gerar engajamento real (enquete/comentario) em vez de so consumo passivo do carrossel.

**Nao produzir ainda** — so guardar a ideia. Quando for pra frente, resolver antes:
- Enquete funciona melhor como Stories (enquete nativa) ou como pergunta no carrossel/legenda pedindo comentario com a raca.
- Se virar um formato recorrente (enquetes com a audiencia), documentar como padrao no PROJETO-INSTAGRAM-OLA.md.

**Opiniao (Claude, 2026-09-04):** ideia boa — a Nori ja tem "observacao de animais" como afinidade na biblia, entao encaixa no personagem. Mas amarrar ao proposito da marca: o pet deveria virar gancho pra episodios futuros de caminhada/movimento em familia (reforca o pilar cardio), senao vira desvio de tema sem retorno. Ressalva: uma vez que a familia "ganha" o pet, ele passa a aparecer nos episodios seguintes — mais um elemento visual pra manter consistente (como o guarda-roupa dos personagens) — vale decidir se topa esse compromisso antes de lancar a enquete.
