...
const SRC = path.resolve('INSTAGRAM OLÁ/Temporada Jornada Olá/Temporada 1/T1E02-vamos-fazer-postado-04-09-2026/arte-bruta/03-corredor-raw.png');
const LOGO_PATH = path.resolve('INSTAGRAM OLÁ/conteudo-inicial/marca-ola-experience-caminho-transparente.png');
const OUT = path.resolve('INSTAGRAM OLÁ/Temporada Jornada Olá/Temporada 1/T1E02-vamos-fazer-postado-04-09-2026/carrossel/01-capa.png');
...
async function main() {
  // Cena limpa gerada direto pro episodio 3 (sem texto/logo gravado).
  ...
  <svg width="${W}" height="${H}" xmlns="http://www.w3.org/2000/svg">
    ...
    <text x="50%" y="${H - 270}" text-anchor="middle" class="headline">
