...
const SRC = path.resolve('INSTAGRAM OLÁ/Temporada Jornada Olá/Temporada 1/T1E13-ainda-nao-saiu/arte-bruta/14-ainda-nao-saiu-raw.png');
const LOGO_PATH = path.resolve('INSTAGRAM OLÁ/conteudo-inicial/marca-ola-experience-caminho-transparente.png');
const OUT = path.resolve('INSTAGRAM OLÁ/Temporada Jornada Olá/Temporada 1/T1E13-ainda-nao-saiu/carrossel/01-capa.png');
...
async function main() {
  ...
  <svg width="${W}" height="${H}" xmlns="http://www.w3.org/2000/svg">
    ...
    <rect x="0" y="0" width="${W}" height="170" fill="url(#top)"/>
    ...
    <text x="50%" y="${H - 290}" text-anchor="middle" class="headline">
      ...
      <tspan x="50%" dy="58">mas quase</tspan>
    </text>
