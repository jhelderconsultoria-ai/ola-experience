// Carrossel "O folego que sobrou" (episodio T1E19, Familia Horizonte, fecha Bloco Cardio).
import fs from 'fs';
import path from 'path';
import sharp from 'sharp';

const OUT_DIR = path.resolve('INSTAGRAM OLÁ/Temporada Jornada Olá/Temporada 1/T1E19-folego-que-sobrou/carrossel');
...
const slides = [
  {
    name: '01-capa',
    eyebrow: 'FAMÍLIA HORIZONTE · T1E19',
    lines: ['O fôlego', 'que sobrou'],
    badge: '1/5',
    showArrow: true,
  },
  {
    ...
    eyebrow: 'LÁ NO T1E09',
    quoteMark: true,
    lines: ['A Nori perguntou:', '"quando vamos de novo?"'],
    footer: 'Não teve resposta grande pra isso.',
    badge: '2/5',
    showArrow: true,
  },
  {
    name: '03-mensagem',
    eyebrow: 'BLOCO CARDIO · FECHAMENTO',
    lines: ['Só o fôlego que foi', 'sobrando, semana'],
    footer: 'depois de semana — sem ninguém anunciar.',
    badge: '3/5',
    showArrow: true,
  },
  {
    name: '04-reflexao',
    eyebrow: 'NA PRÁTICA',
    lines: ['Nada mudou de uma', 'vez. Foi sobrando aos poucos.'],
    badge: '4/5',
    showArrow: true,
  },
  {
    ...
    lines: ['Vocês já sentiram esse', 'tipo de mudança?'],
