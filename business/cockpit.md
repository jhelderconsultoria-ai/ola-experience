...
| 3 | Mapa do Hoje (Hotmart) | Produto low ticket (R$67) na esteira de negócios — desafio de 6 dias pelos pilares da Família Horizonte, com PDF, site de apoio e nota fiscal automática | Aguardando aprovação do KYC pela Hotmart (até 5 dias úteis) e confirmação do eNotas pela operadora de pagamento — sem ação nossa até um dos dois responder | Jorge Helder | Ativo | `business/produtos/mapa-do-hoje/fluxo-e-pendencias.md` |
