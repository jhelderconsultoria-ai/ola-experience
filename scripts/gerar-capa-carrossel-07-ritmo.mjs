// Capa fotografica do carrossel do episodio 6 (cada pessoa tem seu ritmo,
// rotulo T1E06), mesmo padrao visual dos episodios anteriores.
...
const OUT = path.resolve('INSTAGRAM OLÁ/Temporada Jornada Olá/Temporada 1/carrossel-07-ritmo/01-capa.png');
...
async function main() {
  ...
  <svg width="${W}" height="${H}" xmlns="http://www.w3.org/2000/svg">
    ...
    <text x="70" y="76" class="eyebrow">FAMÍLIA HORIZONTE · T1E06</text>
    <text x="${W - 70}" y="76" text-anchor="end" class="badge">1/4</text>
    <text x="50%" y="${H - 290}" text-anchor="middle" class="headline">
      <tspan x="50%" dy="0">Cada um no seu</tspan>
      <tspan x="50%" dy="58">próprio ritmo</tspan>
    </text>
