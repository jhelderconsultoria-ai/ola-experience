...
artista musical **pop (família suave, NÃO gospel — decisão de 07/09/2026)** de
IA com identidade e conta própria — usando o mesmo **modelo de negócio** do
case real @hikaridejesus (1 milhão de seguidores, "1° cantor gospel de IA do
Brasil"), só que em gênero diferente: persona com biografia fixa, música real
gerada com voz (não só letra em texto), distribuição em streaming
(Spotify/Apple Music/YouTube) via agregador digital, Reels de divulgação com
a faixa tocando de verdade.
...
bíblia do personagem Zai na Temporada 1. **Pendência aberta pelo pivô de
gênero (07/09/2026):** esse banco é 100% temática gospel — Jorge precisa
decidir se descarta, guarda pra depois, ou adapta pra letras seculares antes
de qualquer uma virar single (ver `plano-de-negocios.md`, seção 1).
...
| Definir hashtags de descoberta do Zai Cantor | Jorge | Sugestão pronta | — | Rascunho: `#cantordeia` `#artistadeia` `#musicapop` `#popbrasileiro` `#iamusic` `#vozdeia` `#musicaautoral` `#artistavirtual` (ver `business/campanhas/instagram/plano-teste-reels.md`) — validar/ajustar quando a conta for criada |
...
*(Resolvido em 07/09/2026 — ver LOG: Jorge decidiu adaptar as 4 letras existentes pra pop família suave, feito no mesmo dia.)*
...
- 07/09 — Companion: **banco de letras adaptado de gospel pra pop família suave** (decisão do Jorge — adaptar, não descartar). As 4 letras (`zai-poesias.md`, renomeado de `zai-poesias-gospel.md`) tiveram as referências religiosas diretas (Deus, fé, oração) trocadas por família/apoio/afeto, mantendo tom, métrica e mensagem de fundo. Daqui pra frente, letra nova já nasce em pop família suave, sem esse processo de adaptação. Blocker do pivô de gênero resolvido.
- 07/09 — Companion: **pivô de gênero — Zai Cantor NÃO é gospel, é pop família suave** (decisão do Jorge). O Hikari de Jesus continua sendo a referência de modelo de negócio (persona de IA, distribuição em streaming, Reels com áudio real), mas não de gênero musical. Título do tracker e do plano atualizados de "Cantor Gospel de IA" pra "Cantor Pop de IA". Abre blocker novo: o banco de letras existente (`zai-poesias.md`) é gospel e precisa de decisão do Jorge antes da Fase 2 (descartar/guardar/adaptar).
...
- 07/09 — Companion: regra fixada a pedido do Jorge — checklist obrigatório antes de qualquer letra nova do Zai virar oficial (pesquisar título e letra contra obras existentes, checar melodia gerada, documentar autoria em `zai-poesias.md`, não avançar pra produção sem isso). Registrado na seção 6.5 do plano.
