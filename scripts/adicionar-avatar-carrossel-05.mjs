...
// carrossel 05, recortado a olho da arte do parquinho (sem deteccao facial
// disponivel — ajustar manualmente se sair desalinhado).
import path from 'path';
import sharp from 'sharp';

const SRC = path.resolve('INSTAGRAM OLÁ/Temporada Jornada Olá/Temporada 1/artes-base/05-parquinho-raw.png');
const OUT_DIR = path.resolve('INSTAGRAM OLÁ/Temporada Jornada Olá/Temporada 1/carrossel-05-parquinho');
...
// Caixa de rosto estimada a olho na arte 1536x1024 do parquinho (05-parquinho-raw.png).
// Ajustado em 05/09/2026 — o recorte anterior (370,240,190) saia descentralizado
// (mais queixo/boca do que rosto, cabelo cortado no topo).
const FACE_BOX = { left: 335, top: 160, size: 250 };
