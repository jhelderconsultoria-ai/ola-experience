// Capa fotografica do carrossel do episodio T1E10 (a mesma tela, de um jeito diferente).
...
const OUT = path.resolve('INSTAGRAM OLÁ/Temporada Jornada Olá/Temporada 1/T1E10-curiosidade-junto-postado-06-09-2026/carrossel/01-capa.png');
...
async function main() {
  ...
  <svg width="${W}" height="${H}" xmlns="http://www.w3.org/2000/svg">
    ...
    <text x="70" y="76" class="eyebrow">FAMÍLIA HORIZONTE · T1E10</text>
    <text x="${W - 70}" y="76" text-anchor="end" class="badge">1/4</text>
    <text x="50%" y="${H - 290}" text-anchor="middle" class="headline">
      <tspan x="50%" dy="0">A mesma tela,</tspan>
      <tspan x="50%" dy="58">de um jeito diferente</tspan>
    </text>
