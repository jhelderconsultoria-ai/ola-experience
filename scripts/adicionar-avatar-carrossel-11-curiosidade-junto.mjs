...
// carrossel do T1E10 (curiosidade junto).
import path from 'path';
import sharp from 'sharp';

const SRC = path.resolve('INSTAGRAM OLÁ/Temporada Jornada Olá/Temporada 1/T1E10-curiosidade-junto-postado-06-09-2026/arte-bruta/11-curiosidade-junto-raw.png');
const OUT_DIR = path.resolve('INSTAGRAM OLÁ/Temporada Jornada Olá/Temporada 1/T1E10-curiosidade-junto-postado-06-09-2026/carrossel');
...
// Caixa de rosto conferida a olho na arte 1536x1024 (11-curiosidade-junto-raw.png).
const FACE_BOX = { left: 495, top: 155, size: 260 };
...
const slide = {
  ...
  eyebrow: 'ZAI, 15 ANOS',
  quoteMark: true,
  lines: ['Óó, vem ver', 'o que eu achei!'],
  footer: 'A tela virou motivo de união.',
  badge: '2/4',
  showArrow: true,
};
