...
// carrossel 07 (cada pessoa tem seu ritmo), recortado da arte de origem.
import path from 'path';
import sharp from 'sharp';

const SRC = path.resolve('INSTAGRAM OLÁ/Temporada Jornada Olá/Temporada 1/artes-base/07-ritmo-raw.png');
const OUT_DIR = path.resolve('INSTAGRAM OLÁ/Temporada Jornada Olá/Temporada 1/carrossel-07-ritmo');
...
// Caixa de rosto conferida a olho na arte 1536x1024 (07-ritmo-raw.png).
const FACE_BOX = { left: 860, top: 230, size: 180 };
...
const slide = {
  ...
  eyebrow: 'ZAI, 15 ANOS',
  quoteMark: true,
  lines: ['Eu chego quando', 'eu chegar.', 'Ninguém fica esperando.'],
  footer: 'Ritmo próprio não é atraso.',
  badge: '2/4',
  showArrow: true,
};
