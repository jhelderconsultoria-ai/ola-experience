// Carrossel OLÁ BÔNUS "Sem Pressa" — casa na montanha, Zai canta pra família.
// Mesmo molde do T1E16 (capa fotografica + slides de texto), sem numero de
// episodio (e bonus, nao entra na Temporada).
import fs from 'fs';
import path from 'path';
import sharp from 'sharp';

const OUT_DIR = path.resolve('INSTAGRAM OLÁ/POSTAGENS EXTRAS/casa-na-montanha-sem-pressa/carrossel');
...
const slides = [
  ...
  },
  {
    ...
    eyebrow: 'ZAI, 15 ANOS',
    quoteMark: true,
    lines: ['Sem pressa, sem pressa.', 'Eu cresço do meu jeito.'],
    footer: 'Vida é um passo, não é um salto.',
    badge: '2/6',
    showArrow: true,
  },
  {
    name: '03-mensagem',
    eyebrow: 'UMA NOITE NA MONTANHA',
    lines: ['Essa, o Zai nunca', 'tinha cantado pra gente.'],
    badge: '3/6',
    showArrow: true,
  },
  {
  ...
  },
  {
    ...
    lines: ['A correria promete', 'pressa. A gente', 'promete presença.'],
