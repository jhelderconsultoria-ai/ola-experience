// Capa fotografica do carrossel do episodio T1E17 (o folego que ninguem ve).
import path from 'path';
import sharp from 'sharp';

const SRC = path.resolve('INSTAGRAM OLÁ/Temporada Jornada Olá/Temporada 1/T1E17-folego-que-ninguem-ve/arte-bruta/17-folego-que-ninguem-ve-raw-v2.png');
const LOGO_PATH = path.resolve('INSTAGRAM OLÁ/conteudo-inicial/marca-ola-experience-caminho-transparente.png');
const OUT = path.resolve('INSTAGRAM OLÁ/Temporada Jornada Olá/Temporada 1/T1E17-folego-que-ninguem-ve/carrossel/01-capa.png');
...
const HEADLINE = 'O fôlego que ninguém vê';
...
async function main() {
  ...
  <svg width="${W}" height="${H}" xmlns="http://www.w3.org/2000/svg">
    ...
    <text x="70" y="76" class="eyebrow">FAMÍLIA HORIZONTE · T1E17</text>
