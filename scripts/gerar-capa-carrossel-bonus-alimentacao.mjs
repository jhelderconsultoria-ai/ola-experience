// Capa fotografica do carrossel bonus "A bagunca da panqueca" (pilar Alimentacao).
import path from 'path';
import sharp from 'sharp';

const SRC = path.resolve('INSTAGRAM OLÁ/POSTAGENS EXTRAS/bonus-alimentacao-panqueca-postado-10-09-2026/arte-bruta/bonus-alimentacao-panqueca-raw--v2--20260910-1525.png');
const LOGO_PATH = path.resolve('INSTAGRAM OLÁ/conteudo-inicial/marca-ola-experience-caminho-transparente.png');
const OUT = path.resolve('INSTAGRAM OLÁ/POSTAGENS EXTRAS/bonus-alimentacao-panqueca-postado-10-09-2026/carrossel/01-capa.png');
...
const HEADLINE = 'A bagunça da panqueca';
